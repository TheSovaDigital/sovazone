...
(function(){
  ...
  var lastRun = 0;
  var CACHE_VERSION = 'instagram-v2.2';
  ...
  form.addEventListener('submit', async function(e){
    ...
    try{
      var res=await fetch('https://sovazone.vercel.app/api/username-value-v22/',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({username:username,platform:platform,lang:lang,website:''})});
